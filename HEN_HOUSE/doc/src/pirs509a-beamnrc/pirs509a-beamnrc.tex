...
(or source /full directory path to $HEN_HOUSE/scripts/egsnrc_bashrc_additions
                                                              for .bashrc)
source /full directory path to $HEN_HOUSE/scripts/beamnrc_cshrc_additions
(or source /full directory path to $HEN_HOUSE/scripts/beamnrc_bashrc_additions
                                                              for .bashrc)
\end{verbatim}
...
{\tt \$HEN\_HOUSE/scripts/beamnrc\_cshrc\_additions}
(or {\tt \$HEN\_HOUSE/scripts/beamnrc\_cshrc\_additions}) define aliases
...
% The EGSnrcMP distribution is available online at\\
% \htmladdnormallink{{\tt http://irs.inms.nrc.ca/software/egsnrc/}}
% {http://irs.inms.nrc.ca/software/egsnrc/}.  Download the
...
%
% The installation can be obtained from the OMEGA/BEAM distribution
% site at:
%
% \htmladdnormallink{{\tt http://irs.inms.nrc.ca/software/beamnrc/download.html}}
% {http://irs.inms.nrc.ca/software/beamnrc/download.html}
%
...
uncertainties assigned. See
the \htmladdnormallink{report on history by history
statistics in BEAMnrc and DOSXYZnrc}
{http://irs.inms.nrc.ca/software/beamnrc/documentation/pirs791/pirs791.html}\cite{Wa02a} for a complete discussion.
