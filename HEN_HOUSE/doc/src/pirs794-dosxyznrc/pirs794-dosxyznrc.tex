...
A complete list of IRS/NRC documents on the WWW
\htmladdnormallink{is available here.}
{http://irs.inms.nrc.ca/publications/articles/}
\begin{rawhtml}
<br><br>
\end{rawhtml}

There are also links to the \htmladdnormallink{BEAMnrc home
page}{http://www.irs.inms.nrc.ca/inms/irs/BEAM/beamhome.html} and the
\htmladdnormallink{IRS home page.}{http://irs.inms.nrc.ca/}
\begin{rawhtml}
<br><br>
\end{rawhtml}
...
\end{rawhtml}
\copyright
\htmladdnormallink{Copyright 1995-2013, National Research Council of Canada
Ottawa}{http://www.irs.inms.nrc.ca/inms/irs/NRC.copyright.html}
\begin{rawhtml}
<BR> <HR> <P>
\end{rawhtml}
\end{htmlonly}
...
\item [{\tt beamnrc\_cshrc\_additions} (or {\tt beamnrc\_bashrc\_additions})]
...
\indexm{files!beamnrc\_cshrc\_additions}
\indexm{files!beamnrc\_bashrc\_additions}
\indexm{beamnrc\_cshrc\_additions}
\indexm{beamnrc\_bashrc\_additions}
