...
###############################################################################
#
#  EGSnrc BEAMnrc graphical user interface: query filename
...
proc query_filename {next_proc_name dir ext {extrainp ""}} {
    ...
    # a directory browser which includes a filter ($ext) and starting
	...
	if { [file isdirectory $dir] != 0 } {
	    ...
	    cd $dir
	    set tree [pwd]
	    .query.file configure -text $tree
...
#    if [file exists [file join $tree $filename]]==0 {
#	# file doesn't exist, inform and return
#	tk_dialog .error "Error" "That file doesn't exist.  Enter another."\
#		error 0 OK
#	return
#    }
