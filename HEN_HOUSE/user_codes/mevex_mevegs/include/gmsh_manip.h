...
namespace gmsh_manip {
    ...
    TetrahedralMesh mesh_from_gmsh(std::string fileName, std::string prepend_output_name_info);
    ...
    TetrahedralMesh mesh_from_gmsh(std::string fileName, std::string prepend_output_name_info) {
        ...
        std::string output_file = prepend_output_name_info + "_" + fileName + ".results.msh";
