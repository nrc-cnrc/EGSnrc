...
C##############################################################################
C
C  EGSnrc date subroutines stub
...
C                    printed to unit 6.
C
C  As your compiler seems to not support the fdate and date_and_time
C  intrinsics, this is just a stub. It is up to you to implement this
C  subroutine using whatever other means your compiler provides.
C
C***************************************************************************

      subroutine egs_fdate(ounit)
      integer ounit
      write(ounit,'(a,$)') 'egs_fdate(): fix me!'
      end
