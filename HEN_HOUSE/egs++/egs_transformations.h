...
public:
  ...
  */
  bool isRotation() const {
      EGS_Float d = det() - 1; EGS_RotationMatrix t((*this)*inverse());
      if( fabs(d) > 1e-4 || !t.isI() ) return false;
      return true;
  };
  ...
  */
  EGS_RotationMatrix(const EGS_Vector &v) {
      ...
      if( sinz > 1e-15 ) {
          sinz = sqrt(sinz);
          EGS_Float cphi = v.x/sinz; register EGS_Float sphi = v.y/sinz;
          EGS_Float cost = v.z/norm; register EGS_Float sint = -sinz/norm;
  ...
  */
  ...
  inline EGS_Float xx() const { return rxx; };
  inline EGS_Float xy() const { return rxy; };
  inline EGS_Float xz() const { return rxz; };
  inline EGS_Float yx() const { return ryx; };
  inline EGS_Float yy() const { return ryy; };
  inline EGS_Float yz() const { return ryz; };
  inline EGS_Float zx() const { return rzx; };
  inline EGS_Float zy() const { return rzy; };
  inline EGS_Float zz() const { return rzz; };
