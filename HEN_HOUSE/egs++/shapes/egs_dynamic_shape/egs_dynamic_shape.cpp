...
int EGS_DynamicShape::getCoord(EGS_Float rand, EGS_ControlPoint &gipt) {// gipt is a control point struct used to track the current state of the shape (coordinates and time)
    int iindex=0;
    int i;
