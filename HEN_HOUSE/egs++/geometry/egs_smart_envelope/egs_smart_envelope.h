...
public:
      ...
      bool isRealRegion(int ireg) const {
          ...
          int i = ireg - nbase; int j = reg_to_inscr[i];
      ...
      int howfar(int ireg, const EGS_Vector &x, const EGS_Vector &u,
          ...
          if( ireg >= 0 ) {
              ...
              if( ireg < nbase ) {
                  ...
                  if( ibase == ireg || ibase < 0 ) return ibase;
                  ...
                  if( j >= 0 && itype[j] ) {
                      ...
                      if( inscr >= 0 ) {
                          if( newmed ) *newmed = geometries[j]->medium(inscr);
                          return local_start[j] + inscr;
                      }
                  }
                  return ibase;
              ...
              if( inew < 0 ) {
                  if( newmed ) *newmed = g->medium(ibase);
                  return ibase;
              }
