...
#ifndef EGS_MEVEGS_MESH
#define EGS_MEVEGS_MESH
...
#include "TetrahedralMesh.h"
    ...
    #ifdef BUILD_EGS_MEVEGS_MESH_DLL
...
class EGS_MESH_EXPORT EGS_Mevegs_Mesh : public EGS_BaseGeometry {
    ...
    const string type = "EGS_Mevegs_Mesh";
...
public:
  ...
  EGS_Mevegs_Mesh(const TetrahedralMesh& mesh, double scalingFactor, EGS_Application* app) : EGS_BaseGeometry("EGS_Mevegs_Mesh") {
...
EGS_BaseGeometry* createMeshGeometry(EGS_Input *input, EGS_Application *app, double scaling, const TetrahedralMesh& m) {
      ...
      // FIXME: leaky?
      EGS_Mevegs_Mesh* result = new EGS_Mevegs_Mesh(m, scaling, app);
